...
import { Target, Users, Zap, Globe, ShieldCheck, Briefcase } from "lucide-react";
...
export default function AboutPage() {
  return (
    <div className="pt-32 pb-20 bg-[#050505] min-h-screen overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold font-clash text-white mb-8 tracking-tighter leading-[0.9]">
            Building the <br /> 
            <span className="text-accent-cyan italic">African Tech</span> <br /> 
            Standard.
          </h1>
          <p className="text-lg md:text-xl text-white/50 font-jakarta leading-relaxed max-w-2xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-32">
          {values.map((v, i) => (
            ...
            >
              ...
              <h3 className="text-2xl font-bold font-clash text-white mb-4">{v.title}</h3>
              <p className="text-white/40 font-jakarta text-sm leading-relaxed">{v.desc}</p>
            </motion.div>
          ))}
        </div>

        {/* Story Section - Optimized for Local SEO */}
          ...
          <div className="relative group">
             ...
             <div className="glass aspect-[4/3] rounded-[3rem] overflow-hidden relative border border-white/10 flex items-center justify-center">
                <div className="text-center px-10">
                   ...
                   <p className="text-white/20 text-xs font-mono">ESTABLISHED_IN_KIGALI_RWANDA</p>
                </div>
             </div>
          </div>
          
          <div>
            <h2 className="text-4xl md:text-6xl font-bold font-clash text-white mb-8 tracking-tight">
              From Rwanda, <br />
              <span className="text-accent-cyan">For the Continent.</span>
            </h2>
            <p className="text-white/50 font-jakarta mb-6 leading-relaxed">
            ...
            <p className="text-white/50 font-jakarta mb-8 leading-relaxed">
            ...
            <div className="flex gap-10 border-t border-white/5 pt-10">
               <div>
                  <div className="text-3xl font-bold text-white mb-1">EAC</div>
